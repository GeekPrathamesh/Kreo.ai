...
export const createVideo = async (req: Request, res: Response) => {
  ...
  //deduct credits for video generated
  await prisma.user
    .update({
      where: {
        id: userId,
...
const prompt = `
Create a high-quality advertisement video where a person promotes and demonstrates the product with confident gestures and clear expressions for branding and marketing.

Product: ${project.productName}
${project.productDescription || ""}

Style: modern, premium, studio lighting, smooth camera movement.
`;
